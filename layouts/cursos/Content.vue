<template>
    <el-row>
        <el-col :spa="24">
            <el-col class="content" :xs="{span:22, offset:1}" :sm="{span:22, offset:1}" :md="{span:20, offset:2}" :lg="{span:20, offset:2}">
                <img class="img-content-curso" src="../../assets/cursos/img-curso.jpg">
